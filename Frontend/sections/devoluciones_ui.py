...
from Backend.services.service_devolucion import DevolucionService
...
#             self.conn = conn
#             self.entidad_service = DevolucionService(conn)
#             self.pago_service = PagoService(conn)
#             self.articulo_service = ArticuloService(conn)
            
#      #metodos de entidad principal
#     def definir_modelo(self, entidad, pago, articulo):
#         "ID", "Motivo", "Fecha", "Cantidad", "Pago", "Articulo"
#         modelo =[
#             str(entidad['idDevolucion']),
#             entidad['motivo'],
#             str(entidad['fecha']),
...
#             str(entidad['fecha']),
#             str(entidad['cantidad']),
#             str(entidad['Pago_idPago']),
#             str(entidad['Articulo_idArticulo'])
#         ]
...
#     def entidad_crear(self, valores, pago):
#         resultado = self.entidad_service.crear_devolucion(valores["motivo"], valores["fecha"], valores["cantidad"], valores["pago"])
        
#         return resultado
    
#     def entidad_actualizar(self, idEntidad, valores, pago):
#         resultado = self.entidad_service.actualizar_devolucion(idEntidad, valores["motivo"], valores["fecha"], valores["cantidad"], valores["pago"])
#         return resultado
    
#     def entidad_buscar_todos(self):
#         resultado = self.entidad_service.buscar_devoluciones()
        
#         return resultado
    
#     def entidad_buscar_generico(self, criterio_busqueda):
#         resultado = self.entidad_service.buscar_devoluciones_generico(criterio_busqueda)
#         return resultado
    
#     def entidad_buscar_por_id(self, entidad_id):
#         resultado = self.entidad_service.buscar_devolucion(entidad_id)
#         return resultado
    
#     def entidad_eliminar(self, entidad_id):
#         resultado = self.entidad_service.eliminar_devolucion(entidad_id)
#         return resultado              



# ############################################## - - - UI                
#     def setupUi(self, FormDevoluciones, palette):
#         self.formulario = FormDevoluciones
#         self.nombre_app = "Gestor de Biblioteca"
#         self.nombre_tab = "DEVOLUCIONES"
#         self.sing = "Devolucion"
#         self.plural = self.sing+"s"
#         self.columnas = ["ID", "Motivo", "Fecha", "Cantidad", "Pago", "Articulo"]
#         self.columnas.extend(["Actualizar", "Eliminar"])
        
#         self.campos_a_mostrar = ["Motivo", "Fecha", "Cantidad", "Pago"]
...
#             empresa_id = 1
#             self.entidad_actualizar(self.idEntidad, valores, empresa_id)
